...
def coulomb_counting(current, time_delta, initial_charge=0):
    """
    ...
    """
    charge_delta = current * time_delta / 3600  # convert seconds to hours (Ah)
...
while(soc < 100):
    updated_charge = coulomb_counting(current, time_delta, initial_charge=updated_charge)
